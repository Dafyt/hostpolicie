...
client.on('message', message => {
    ...
    if(jmeno_promene[0] === '!oznámeníxxxx'){
        const exampleEmbed = new Discord.MessageEmbed()
            .setColor('#00BFFF')
            ...
            .setDescription(jmeno_promene[1])                //Text embedu
            .setTimestamp()
            .setFooter(`Ozznamovatel ${message.author.username}`, 'https://media.discordapp.net/attachments/729654155798380548/769906915022471208/pcr.png');           // URL obrázku dole
        message.channel.send(exampleEmbed)
        message.delete()
    }
    if(jmeno_promene[0] === '!pokuta'){
        const exampleEmbed = new Discord.MessageEmbed()
            ...
            .setTimestamp()
            .setFooter(`Pokutu vystavil ${message.author.username}`, 'https://imgur.com/9XYuBrO');           // URL obrázku dole
        message.channel.send(exampleEmbed)
        message.delete()
    }
